/*
// IPTV Plugin - List View Edition
// Based on MaxTV Plugin
*/
;(function () {
'use strict';
var plugin = {
    component: 'max_iptv_list', // Змінено ID, щоб не конфліктував з оригіналом, якщо він встановлений
...
//Стиль - змінено для списку
Lampa.Template.add(plugin.component + '_style', '<style>#PLUGIN_epg{margin-right:1em}.PLUGIN-program__desc{font-size:0.9em;margin:0.5em;text-align:justify;max-height:15em;overflow:hidden;}.PLUGIN.category-full{padding-bottom:10em}#PLUGIN{float:right;padding: 1.2em 0;width: 30%;}.PLUGIN-details__group{font-size:1.3em;margin-bottom:.9em;opacity:.5}.PLUGIN-details__title{font-size:4em;font-weight:700}.PLUGIN-details__program{padding-top:4em}.PLUGIN-details__program-title{font-size:1.2em;padding-left:4.9em;margin-top:1em;margin-bottom:1em;opacity:.5}.PLUGIN-details__program-list>div+div{margin-top:1em}.PLUGIN-details__program>div+div{margin-top:2em}.PLUGIN-program{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;font-size:1.2em;font-weight:300}.PLUGIN-program__time{-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0;width:5em;position:relative}.PLUGIN-program.focus .PLUGIN-program__time::after{content:\'\';position:absolute;top:.5em;right:.9em;width:.4em;background-color:#fff;height:.4em;-webkit-border-radius:100%;-moz-border-radius:100%;border-radius:100%;margin-top:-0.1em;font-size:1.2em}.PLUGIN-program__progressbar{width:10em;height:0.3em;border:0.05em solid #fff;border-radius:0.05em;margin:0.5em 0.5em 0 0}.PLUGIN-program__progress{height:0.25em;border:0.05em solid #fff;background-color:#fff;max-width: 100%}.PLUGIN-list-item {display: flex; align-items: center; padding: 0.8em 1.5em; margin: 0.4em 1em; background: rgba(255,255,255,0.05); border-radius: 0.5em; cursor: pointer; transition: background 0.3s;}.PLUGIN-list-item.focus {background: #fff; color: #000;}.PLUGIN-list-item img {width: 40px; height: 40px; object-fit: contain; margin-right: 15px; border-radius: 4px;}.PLUGIN-list-item-title {flex-grow: 1; font-size: 1.2em; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;}.PLUGIN-list-item .card__age {margin-left: auto; width: 150px; display: none;}.PLUGIN-list-item.focus .card__epg-progress {background-color: rgba(0,0,0,0.2); border-color: rgba(0,0,0,0.5);}.PLUGIN-list-item .card__epg-progress {height: 4px; background: rgba(255,255,255,0.2); width: 100%; position: relative; margin-top: 5px; border-radius: 2px;}.PLUGIN-list-item .card__epg-progress > div {height: 100%; background: #fff; border-radius: 2px;}.PLUGIN-list-item.focus .card__epg-progress > div {background: #000;}.PLUGIN-list-item .card__epg-title {font-size: 0.8em; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; opacity: 0.7;}.PLUGIN-list-item .icon--book, .PLUGIN-list-item .icon--timeshift {width: 20px; height: 20px; margin-left: 10px; opacity: 0.5;}</style>'.replace(/PLUGIN/g, plugin.component));
...
function pluginPage(object) {
	...
	var bulkFn = bulkWrapper(function (channel) {
        ...
        // НОВА ВЕРСТКА СПИСКОМ
        var item = $('<div class="PLUGIN-list-item selector"></div>'.replace(/PLUGIN/g, plugin.component));
        
        var imgHtml = channel['tvg-logo'] ? '<img src="' + channel['tvg-logo'] + '" onerror="this.style.display=\'none\'">' : '';
        item.append(imgHtml);
        
        item.append('<div class="PLUGIN-list-item-title">' + channel.Title + '</div>'.replace(/PLUGIN/g, plugin.component));
        
        // EPG Progress Box
        var epgBox = $('<div class="card__age"><div class="card__epg-title js-epgTitle"></div><div class="card__epg-progress js-epgProgress"><div></div></div></div>');
        item.append(epgBox);
        
        // Icons box
        var iconsBox = $('<div style="display:flex; align-items:center;"></div>');
        item.append(iconsBox);

	    var favIcon = $('<div class="icon--book hide" style="background-image:url(https://vi.rootu.top/img/icon/book.svg);"></div>');
		...
		iconsBox.append('<div class="icon--timeshift" style="background-image:url(https://epg.rootu.top/img/icon/timeshift.svg);"></div>');
	...
	{
	    bulk: 25, // Можна трохи збільшити bulk для списку, він рендериться швидше за картки
